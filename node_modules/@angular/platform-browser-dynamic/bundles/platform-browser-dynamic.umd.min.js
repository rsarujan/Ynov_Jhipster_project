...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */}(this._defaultOptions.concat(e));return r.Injector.create([_,{provide:t.CompilerConfig,useFactory:function(){return new t.CompilerConfig({useJit:o.useJit,jitDevMode:r.isDevMode(),defaultEncapsulation:o.defaultEncapsulation,missingTranslation:o.missingTranslation,preserveWhitespaces:o.preserveWhitespaces})},deps:[]},o.providers]).get(r.Compiler)},e}();function M(e){for(var t=e.length-1;t>=0;t--)if(void 0!==e[t])return e[t]}var O=r.createPlatformFactory(r.platformCore,"coreDynamic",[{provide:r.COMPILER_OPTIONS,useValue:{},multi:!0},{provide:r.CompilerFactory,useClass:E,deps:[r.COMPILER_OPTIONS]}]),P=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return s(t,e),t.prototype.get=function(e){var t,r,o=new Promise((function(e,o){t=e,r=o})),n=new XMLHttpRequest;return n.open("GET",e,!0),n.responseType="text",n.onload=function(){var o=n.response||n.responseText,i=1223===n.status?204:n.status;0===i&&(i=o?200:0),200<=i&&i<=300?t(o):r("Failed to load "+e)},n.onerror=function(){r("Failed to load "+e)},n.send(),o},t.decorators=[{type:r.Injectable}],t}(t.ResourceLoader),A=[n.ɵINTERNAL_BROWSER_PLATFORM_PROVIDERS,{provide:r.COMPILER_OPTIONS,useValue:{providers:[{provide:t.ResourceLoader,useClass:P,deps:[]}]},multi:!0},{provide:r.PLATFORM_ID,useValue:o.ɵPLATFORM_BROWSER_ID}],S=function(e){function t(){var t=e.call(this)||this;if(t._cache=r.ɵglobal.$templateCache,null==t._cache)throw new Error("CachedResourceLoader: Template cache was not found in $templateCache.");return t}return s(t,e),t.prototype.get=function(e){return this._cache.hasOwnProperty(e)?Promise.resolve(this._cache[e]):Promise.reject("CachedResourceLoader: Did not find cached template for "+e)},t}(t.ResourceLoader),T=new r.Version("10.0.0"),w=[{provide:t.ResourceLoader,useClass:S,deps:[]}],D=r.createPlatformFactory(O,"browserDynamic",A);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
