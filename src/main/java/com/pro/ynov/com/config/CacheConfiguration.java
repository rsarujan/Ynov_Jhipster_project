package com.pro.ynov.com.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pro.ynov.com.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pro.ynov.com.repository.UserRepository.USERS_BY_EMAIL_CACHE);
